...
Run: `node --test 'wall/test/render.test.mjs'`
Expected: PASS, 12 tests. Then `node --test 'wall/test/*.test.mjs'` → 28.
...
Run: `node --test 'wall/test/*.test.mjs'`
Expected: PASS — 37 tests (28 + 5 atproto + 4 render).
...
| PR | Repo | What |
|---|---|---|
| 1 | `cultureblocs-site` | Tasks 1–5: `wall/`, the rewrites, the README line. 37 tests, the first in the repo |
