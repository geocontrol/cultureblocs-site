...
Run: `node --test 'wall/test/render.test.mjs'`
Expected: PASS, 13 tests. Then `node --test 'wall/test/*.test.mjs'` → 29.
...
Run: `node --test 'wall/test/*.test.mjs'`
Expected: PASS — 38 tests (29 + 5 atproto + 4 render).
...
| PR | Repo | What |
|---|---|---|
| 1 | `cultureblocs-site` | Tasks 1–5: `wall/`, the rewrites, the README line. 38 tests, the first in the repo |
